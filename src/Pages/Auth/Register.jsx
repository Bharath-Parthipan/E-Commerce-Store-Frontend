        ...
        <div className="mr-[4rem] mt-[5rem]">
          ...
          <form onSubmit={submitHandler} className="container w-[40rem]">
            <div className="my-[2rem]">
              ...
              <input type="text" id="name" className="mt-1 p-2 border rounded w-full" placeholder="Enter name" value={username} onChange={(e) => setName(e.target.value)} />
            </div>
            ...
            <button disabled={isLoading} type="submit" className="bg-[lime] text-white px-4 py-2 rounded cursor-pointer my-[1rem]">
          ...
          <div className="mt-4">
            <p>
              ...
              <Link to={redirect ? `/login?redirect=${redirect}` : "/login"} className="text-[lime] hover:underline">Login</Link>
            </p>
          </div>
        </div>
      </section>
