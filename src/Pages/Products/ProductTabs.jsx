          ...
          <div className="mt-4">
            {userInfo ? (
              <form onSubmit={submitHandler}>
                ...
                <button type="submit" disabled={loadingProductReview} className="bg-[lime] text-white py-2 px-4 rounded-lg">
                  Submit
                </button>
              </form>
            ) : (
              <p className="text-[lime] hover:underline">
          ...
          <>
            ...
            <div>
              {product.reviews.map((review) => (
                <div key={review._id} className="border p-4 rounded-lg xl:ml-[2rem] sm:ml-[0rem] xl:w-[50rem] sm:w-[24rem] mb-5">
                  <div className="flex justify-between">
                    <strong className="text-[#949494]">{review.name}</strong>
